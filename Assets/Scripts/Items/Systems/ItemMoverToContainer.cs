...
{
    public class ItemMoverToContainer : IEcsRunSystem
    {
        private readonly EcsFilter<Item, MoveToContainer> _filter = null;
        ...
        public void Run()
        {
            ...
            foreach (var i in _filter)
            {
                ...
                if (item.Transform.localPosition == Vector3.zero)
                {
                    ...
                    entity.Del<MoveToContainer>();
                    entity.Get<ItemInContainer>();
                }
            }
        }
    }
